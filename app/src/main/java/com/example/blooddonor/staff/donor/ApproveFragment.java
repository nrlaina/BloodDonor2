...
public class ApproveFragment extends Fragment implements DonorAdapter.OnDonorDetailsClickListener {

    private RecyclerView recyclerViewApprove;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // init component
        recyclerViewApprove = view.findViewById(R.id.rcApproveDonors);

        // recycler view
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);

        recyclerViewApprove.setLayoutManager(linearLayoutManager);
        donorAdapter = new DonorAdapter(donors, this);
        recyclerViewApprove.setAdapter(donorAdapter);
